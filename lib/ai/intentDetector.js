...
const PATTERNS = [
  ...
  ["BOOKING",      /randevu\s*(al|almak|oluştur|yap|istiyorum|almak\s+istiyorum)|book(?:ing)?|rezerv|slot\s*(var\s*mı|ayırt)/i],
  ...
  ["REVIEWS",      /yorum|puan|değerlendirme|review|rating|kaç\s+yıldız|nasıl\s+(bir\s+)?(berber|yer|salon)/i],
