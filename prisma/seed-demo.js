...
const BARBERS = [
  { id: "demo-brb-1", slug: "mehmet", nameTr: "Mehmet Yılmaz", nameEn: "Mehmet Yilmaz", titleTr: "Salon Sahibi & Baş Berber", titleEn: "Owner & Master Barber", bioTr: "20 yıllık deneyimle modern ve klasik kesimlerde uzman.",            bioEn: "Master of modern and classic cuts with 20 years of experience.", avatar: "MY", color: "#111827", yearsExp: 20, rating: 4.9, reviewCount: 184, specialties: ["Klasik Kesim", "Fade", "Sakal Tasarımı"] },
  { id: "demo-brb-2", slug: "ahmet",   nameTr: "Ahmet Demir",   nameEn: "Ahmet Demir",   titleTr: "Kıdemli Berber",            titleEn: "Senior Barber",         bioTr: "Fade ve skin cut konusunda uzman, detaycı çalışma tarzı ile tanınır.", bioEn: "Specialist in fade and skin cut, known for his meticulous work.", avatar: "AD", color: "#1C4532", yearsExp: 10, rating: 4.8, reviewCount: 127, specialties: ["Fade", "Skin Cut", "Modern Stil"] },
  { id: "demo-brb-3", slug: "burak",   nameTr: "Burak Aydın",   nameEn: "Burak Aydin",   titleTr: "Berber",                    titleEn: "Barber",                bioTr: "Trendleri yakından takip eden, genç ve dinamik berber.",               bioEn: "Young, dynamic barber who keeps up with current trends.",         avatar: "BA", color: "#7C2D12", yearsExp: 5,  rating: 4.7, reviewCount: 78,  specialties: ["Tekstür", "Modern Kesim", "Sakal"] },
  { id: "demo-brb-4", slug: "can",     nameTr: "Can Şahin",     nameEn: "Can Sahin",     titleTr: "Berber",                    titleEn: "Barber",                bioTr: "Müşteri memnuniyetine verdiği önemle bilinen titiz berber.",          bioEn: "Detail-oriented barber known for prioritizing customer satisfaction.", avatar: "CŞ", color: "#1E3A5F", yearsExp: 3,  rating: 4.7, reviewCount: 46,  specialties: ["Klasik Kesim", "Çocuk Kesimi", "Sakal"] },
];
